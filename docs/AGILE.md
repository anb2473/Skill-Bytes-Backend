# Agile Practices
Hello, and thank you for contributing to the Skill Bytes project! We are currently using an AGILE framework to manage work. Below is a list of planned features, if you finish any feature please check it off on the list.
